...
jsonKey = {
    ...
    "Age": "The age of the soldier in the paragraph's context.",
    "Year Born": "The year the soldier was born.",
    "Other": {
        "other1": "Any other information you think would be useful. Replace the key other1 with a more descriptive key. This info should be a short fact, not a long paragraph.",
        "other2": "More information you think would be useful. Feel free to add more or less values in the Other json as you see fit."
    }
}
